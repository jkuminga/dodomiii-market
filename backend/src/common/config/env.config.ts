...
export default () => ({
  ...
  NOTIFICATIONS_ADMIN_ORDER_STATUS_SUMMARY_ENABLED: parseBoolean(
    process.env.NOTIFICATIONS_ADMIN_ORDER_STATUS_SUMMARY_ENABLED,
    parseBoolean(process.env.NOTIFICATIONS_ADMIN_STATUS_SUMMARY_ENABLED, true),
  ),
  NOTIFICATIONS_ADMIN_SHIPMENT_SUMMARY_ENABLED: parseBoolean(
    process.env.NOTIFICATIONS_ADMIN_SHIPMENT_SUMMARY_ENABLED,
    parseBoolean(process.env.NOTIFICATIONS_ADMIN_STATUS_SUMMARY_ENABLED, true),
  ),
